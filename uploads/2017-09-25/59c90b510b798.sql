...
CREATE TABLE IF NOT EXISTS `accusations` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='书记信箱' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `advices` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='建言献策' AUTO_INCREMENT=2 ;
...
(39, 0, 'Superviese', '监督责任', 1, 1, ''),
(40, 39, 'inarchitecture', '支队纪委组织架构', 1, 1, ''),
(41, 39, 'Inlist', '纪委领导班子集体责任清单', 1, 1, ''),
(42, 39, 'Inlist/initems', '监督责任分解清单落实情况', 1, 1, ''),
(43, 39, 'Inlist/count', '纪委监督责任落实统计图', 1, 1, ''),
(44, 39, 'Inleaderlist', '纪委主要负责人责任', 1, 1, ''),
(45, 39, 'Inmember', '监督责任分解清单落实情况成员管理', 1, 1, ''),
(46, 39, 'Inmitem', '监督责任分解清单落实情况事项管理', 1, 1, ''),
(47, 39, 'Inmitem/count', '监督责任分解清单落实情况统计图', 1, 1, ''),
(48, 40, 'Admin/Organize/inarchitecture', '查看', 1, 1, ''),
(49, 40, 'Admin/Organize/editInarchitecture', '修改', 1, 1, ''),
(50, 41, 'Admin/Inlist/plists', '增加', 1, 1, ''),
(51, 41, 'Admin/Inlist/listEdit', '修改', 1, 1, ''),
(52, 41, 'Admin/Inlist/listDelete', '删除', 1, 1, ''),
(53, 41, 'Admin/Inlist/index', '查看', 1, 1, ''),
(54, 42, 'Admin/Inlist/initems', '增加', 1, 1, ''),
(55, 42, 'Admin/Inlist/itemEdit', '修改', 1, 1, ''),
(56, 42, 'Admin/Inlist/itemDelete', '删除', 1, 1, ''),
(57, 42, 'Admin/Inlist/itemsDelete', '批量删除', 1, 1, ''),
(58, 42, 'Admin/Inlist/viewItem', '查看', 1, 1, ''),
(59, 43, 'Admin/Inlist/count', '查看', 1, 1, ''),
(60, 44, 'Admin/Inleaderlist/index', '查看', 1, 1, ''),
(61, 44, 'Admin/Inleaderlist/edit,Admin/Inleaderlist/update', '修改', 1, 1, ''),
(62, 45, 'Admin/Inmember/add', '增加', 1, 1, ''),
(63, 45, 'Admin/Inmember/edit', '修改', 1, 1, ''),
(64, 45, 'Admin/Inmember/delete', '删除', 1, 1, ''),
(65, 45, 'Admin/Inmember/index', '查看', 1, 1, ''),
(66, 46, 'Admin/Inmitem/index', '查看', 1, 1, ''),
(67, 46, 'Admin/Inmitem/add', '添加', 1, 1, ''),
(68, 46, 'Admin/Inmitem/edit', '修改', 1, 1, ''),
(69, 46, 'Admin/Inmitem/delete', '删除', 1, 1, ''),
(70, 46, 'Admin/Inmitem/deletes', '批量删除', 1, 1, ''),
(71, 47, 'Admin/Inmitem/count', '查看', 1, 1, ''),
(72, 46, 'Admin/Inmitem/upload,Admin/Inmitem/uploadFiles', '上传文件', 1, 1, ''),
(73, 42, 'Admin/Inlist/itemUpload,Admin/Inlist/uploadFiles', '上传文件', 1, 1, ''),
(74, 0, 'Power', '权力监控', 1, 1, ''),
(75, 74, 'Pmonitor', '四权监控', 1, 1, ''),
(76, 74, 'oarchitecture', '支队组织架构', 1, 1, ''),
(77, 74, 'Iposition', '领导岗位权力', 1, 1, ''),
(78, 74, 'Dposition', '部门岗位权力', 1, 1, ''),
(79, 74, 'Pflow', '权力运行流程', 1, 1, '');
...
CREATE TABLE IF NOT EXISTS `bnegatives` (
  ...
  `rid` int(11) DEFAULT NULL COMMENT '记录评价的ID',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='党风廉政建设差评记录' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `bnegatives`
--

INSERT INTO `bnegatives` (`id`, `bid`, `rid`, `evaluatetime`, `name`, `number`, `phone`, `content`) VALUES
(2, 2, 5, 1506224191, '张忠', 444444444, '666666666', '测试内容来一句'),
(1, 8, 7, 1506224191, '李敏', 5556666, '3222323', '和规范化广发华福徐徐程序的非官方个电饭锅电饭锅');
...
CREATE TABLE IF NOT EXISTS `cimportants` (
  ...
  `pid` varchar(255) NOT NULL COMMENT '权力id',
  `settime` int(11) NOT NULL COMMENT '设置时间',
  `updatetime` int(11) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='监控重点' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `cimportants`
--

INSERT INTO `cimportants` (`id`, `oid`, `mid`, `pid`, `settime`, `updatetime`) VALUES
(1, 1, 1, '1,2', 0, 1506335359);
...
CREATE TABLE IF NOT EXISTS `dpostions` (
  ...
  `updatetime` int(11) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='部门岗位权力' AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `keymodel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cid` int(11) NOT NULL COMMENT '监控重点id',
  `tid` int(11) NOT NULL COMMENT '表id',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='监控重点使用哪个数据表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pbuilds` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='党风廉政建设' AUTO_INCREMENT=12 ;

--
-- 转存表中的数据 `pbuilds`
--

INSERT INTO `pbuilds` (`id`, `oid`, `content`, `describe`, `addtime`, `status`) VALUES
(2, 1, '个梵蒂冈梵蒂冈梵蒂冈', NULL, 6666666, '1'),
(8, 1, '反反复复付付付付付付付付 出钞出钞错错错错', NULL, 1506224191, '1'),
(1, 1, 'v从v程序需', NULL, 1506224191, '1'),
(9, 1, '反反复复付付付付付付付付 出钞出钞错错错错', NULL, 1506224191, '1'),
(10, 1, '反反复复付付付付付付付付 出钞出钞错错错错', '防守打法鼎折覆餗', 1506224191, '2'),
(11, 1, 'test', '似懂非懂是算法所示是', 1506238623, '2');
...
CREATE TABLE IF NOT EXISTS `pbuildsresult` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bid` int(11) DEFAULT NULL COMMENT '对应pbuilds表的ID',
  `result` enum('1','2','3','4') DEFAULT NULL COMMENT '1:好，2：较好，3：一般，4：差',
  `oid` int(11) DEFAULT NULL COMMENT '对应组织ID',
  `addtime` int(11) DEFAULT NULL COMMENT '评价时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9 ;

--
-- 转存表中的数据 `pbuildsresult`
--

INSERT INTO `pbuildsresult` (`id`, `bid`, `result`, `oid`, `addtime`) VALUES
(1, 2, '1', 1, 1506224191),
(2, 2, '1', 1, 1506224191),
(3, 2, '2', 1, 1506224191),
(6, 8, '3', 1, 1506224191),
...
(1, '四权监控', '<p>ggg</p>', 1, 1505679366, 1506334803, '1'),
...
CREATE TABLE IF NOT EXISTS `psuggests` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='党风廉政建设意见和建议' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `psuggests`
--

INSERT INTO `psuggests` (`id`, `oid`, `content`, `addtime`) VALUES
(2, 1, '通天塔', 4444444);
...
CREATE TABLE IF NOT EXISTS `reports` (
  ...
  `content` text NOT NULL COMMENT '内容',
  `attachment` varchar(255) NOT NULL DEFAULT '0' COMMENT '附件',
  `report` varchar(20) NOT NULL DEFAULT '0' COMMENT '举报人姓名',
  `reportId` varchar(20) NOT NULL DEFAULT '0' COMMENT '举报人证件号',
  ...
  `oid` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='举报' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `reports`
--

INSERT INTO `reports` (`id`, `rname`, `unit`, `dutiesId`, `title`, `content`, `attachment`, `report`, `reportId`, `status`, `reportTime`, `handleTime`, `oid`) VALUES
(1, '4让人', '1', 2, '3333', '333333333333333', '0', '方法', '1111111', '1', 333333, 0, 1);
...
CREATE TABLE IF NOT EXISTS `tmodels` (
  ...
  `addtime` int(11) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='存储创建了哪些存储权力运行情况的数据表' AUTO_INCREMENT=1 ;
