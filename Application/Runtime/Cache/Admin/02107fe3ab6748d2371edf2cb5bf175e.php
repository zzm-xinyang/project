...
<body>
<div class="pd-20">
    <form action="<?php echo U('Admin/Plist/listUpdate','','');?>" method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>领导班子集体责任：</label>
            <div class="formControls col-10">
                <input type="text" class="input-text" value="<?php echo ($list['item']); ?>" name="item">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-2">详细内容：</label>
            <input type="hidden" value="<?php echo ($list['content']); ?>" id="content">
            <div class="formControls col-10">
        ...
        <div class="row cl text-l">
            <div class="col-10 col-offset-2">
                <input type="hidden" name="oid" value="<?php echo ($list['oid']); ?>" />
