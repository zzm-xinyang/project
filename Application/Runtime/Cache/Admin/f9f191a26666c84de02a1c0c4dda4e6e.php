...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 执纪问责<span class="c-gray en">&gt;</span> 四种形态统计 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-5">
	<div class="mt-20">
...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            name: '数量',
            data: [<?php echo ($szxtnum[0]); ?>, <?php echo ($szxtnum[1]); ?>, <?php echo ($szxtnum[2]); ?>, <?php echo ($szxtnum[3]); ?>]
...
function show(index){
		var url = "/monitor/index.php/Admin/Szxttj/index";
		$.ajax({
        dataType:'json',
        type:'post',
        url:url,
        ...
        success:function(msg){
          $('#container').highcharts({
			        ...
			        series: [{
			            name: '数量',
			            data: [parseInt(msg.first), parseInt(msg.second), parseInt(msg.third), parseInt(msg.fourth)]
			        }]
			    });
        }
    });
