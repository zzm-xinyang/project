...
<div class="pd-20">
	<form action="<?php echo U('News/xwdt_edit_submit');?>?newsid=<?php echo ($newslist[0]["id"]); ?>" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>标题：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<?php echo ($newslist[0]["title"]); ?>" placeholder="" id="" name="newstitle">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-10"> 
				<script id="editor" type="text/plain" style="width:100%;height:400px;" name="editor"><?php echo ($newslist[0]["content"]); ?></script>
			</div>
		</div>
