...
<div class="pd-2">
    <div class="cl pd-5 bg-1 bk-gray mt-5"> <span class="l"><a class="btn btn-primary radius" onclick=picture_add('修改党委领导班子成员责任清单',"<?php echo U('Pmemberlist/edit',array('id'=>$list['id']),'');?>") href="javascript:;"><i class="Hui-iconfont">&#xe60c;</i>修改党委领导班子成员责任清单</a></span> </div>
