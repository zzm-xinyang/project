...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 主体责任<span class="c-gray en">&gt;</span> 支队党委组织架构 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-5">
    <div class="cl pd-5 bg-1 bk-gray mt-3"> <span class="l"><a class="btn btn-primary radius" onclick=picture_add('修改架构图','<?php echo U("Organize/editInarchitecture","oid=$oid","");?>') href="javascript:;"><i class="Hui-iconfont">&#xe60c;</i>修改架构图</a></span> </div>
    <div class="mt-20 text-c">
        <img src="/monitor/uploads/<?php echo ($picture); ?>" alt="党委组织架构图" class="thumbnail" width="95%">
    </div>
</div>
