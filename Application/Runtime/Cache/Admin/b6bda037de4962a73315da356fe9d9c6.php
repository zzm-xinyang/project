...
<div class="pd-5">
    <div class="cl pd-5 bg-1 bk-gray mt-3"> <span class="l"><a class="btn btn-primary radius" onclick=picture_add('修改架构图','<?php echo U("Organize/editOarchitecture","oid=$oid","");?>') href="javascript:;"><i class="Hui-iconfont">&#xe60c;</i>修改架构图</a></span> </div>
