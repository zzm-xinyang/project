...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 监督责任<span class="c-gray en">&gt;</span> 纪委主要负责人责任清单 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-2">
    <div class="cl pd-5 bg-1 bk-gray mt-5"> <span class="l"><a class="btn btn-primary radius" onclick=picture_add('修改纪委主要负责人责任清单',"<?php echo U('Inleaderlist/edit',array('id'=>$list['id']),'');?>") href="javascript:;"><i class="Hui-iconfont">&#xe60c;</i>修改纪委主要负责人责任清单</a></span> </div>
