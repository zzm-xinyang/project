    ...
    <div id="tab-system" class="HuiTab">
        ...
        <div class="tabCon">
            <div class="pd-15 radius lh-22 mb-5" style="background: #eee;">
                <h4><strong>部门岗位权力清单</strong>&nbsp;<a class="btn btn-primary radius pl-10 pr-10 add" onclick=ql_add('添加权力','<?php echo U("Dposition/add",array("oid"=>$oid),"");?>') href="javascript:;" >+</a></h4>
                <ul class="list lh-24">
                    <?php if(is_array($contents[0])): $k = 0; $__LIST__ = $contents[0];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($k % 2 );++$k;?><li>
                            <?php if($k == 1): ?><a href="<?php echo U('Dposition/find',array('id'=>$m['id']),'');?>"  class="cur"><span><?php echo ($m['duty']); ?></span><span><?php echo ($m['name']); ?></span><input type="hidden" value="<?php echo ($m['id']); ?>"/></a>&nbsp;&nbsp;
                                <?php else: ?>
                                <a href="<?php echo U('Dposition/find',array('id'=>$m['id']),'');?>"><span><?php echo ($m['duty']); ?></span><span><?php echo ($m['name']); ?></span><input type="hidden" value="<?php echo ($m['id']); ?>"/></a>&nbsp;&nbsp;<?php endif; ?>

                            <a title="修改" class="ml-5" onclick=ql_edit("修改","<?php echo U('Dposition/edit',array('id'=>$m['id']),'');?>") href="javascript:;"><img src="/monitor/Public/admin/images/pen.png" width="12"/><a>&nbsp;
                                <a title="删除" href="javascript:;" onclick="member_del(this,'1')" class="ml-5" style="text-decoration:none" id="<?php echo U('Dposition/delete',array('id'=>$m['id']),'');?>"><img src="/monitor/Public/admin/images/delete.png" width="12"/></a>
            ...
            <div class="pd-15 radius lh-22 mb-5 content" style="background: #eee;">
                ...
                <div class="pl-20 dutys">
                    <?php echo ($contents[0][0]['dutys']); ?>
                   </empty>
                </div>
                <h4>风险清单</h4>
                <div class="pl-20 risks">
                    <?php echo ($contents[0][0]['risks']); ?>
                </div><br/>
                <h4>风险等级</h4>
                <div class="pl-20 rlevel">
                    <?php echo ($contents[0][0]['rlevel']); ?>
                </div>
                <h4>防控清单</h4>
                <div class="pl-20 controls">
                    <?php echo ($contents[0][0]['controls']); ?>
                </div>
            </div>
        </div>
        <div class="tabCon">
            ...
            <div class="pd-15 radius lh-22 mb-5 content" style="background: #eee;">
                <h4><span class="who"></span>主要职责清单</strong></h4>
                <div class="pl-20 dutys">
                    <?php echo ($contents[1][0]['dutys']); ?>
                </div>
                <h4>风险清单</h4>
                <div class="pl-20 risks">
                    <?php echo ($contents[1][0]['risks']); ?>
                </div><br/>
                <h4>风险等级</h4>
                <div class="pl-20 rlevel">
                    <?php echo ($contents[1][0]['rlevel']); ?>
                </div>
                <h4>防控清单</h4>
                <div class="pl-20 controls">
                    <?php echo ($contents[1][0]['controls']); ?>
                </div>
            </div>
        </div>
        <div class="tabCon">
            ...
            <div class="pd-15 radius lh-22 mb-5 content" style="background: #eee;">
                <h4><span class="who"></span>主要职责清单</strong></h4>
                <div class="pl-20 dutys">
                    <?php echo ($contents[2][0]['dutys']); ?>
                </div>
                <h4>风险清单</h4>
                <div class="pl-20 risks">
                    <?php echo ($contents[2][0]['risks']); ?>
                </div><br/>
                <h4>风险等级</h4>
                <div class="pl-20 rlevel">
                    <?php echo ($contents[2][0]['rlevel']); ?>
                </div>
                <h4>防控清单</h4>
                <div class="pl-20 controls">
                    <?php echo ($contents[2][0]['controls']); ?>
                </div>
            </div>
        </div>
        <div class="tabCon">
            ...
            <div class="pd-15 radius lh-22 mb-5 content" style="background: #eee;">
                <h4><span class="who"></span>主要职责清单</strong></h4>
                <div class="pl-20 dutys">
                    <?php echo ($contents[3][0]['dutys']); ?>
                </div>
                <h4>风险清单</h4>
                <div class="pl-20 risks">
                    <?php echo ($contents[3][0]['risks']); ?>
                </div><br/>
                <h4>风险等级</h4>
                <div class="pl-20">
                    <?php echo ($contents[3][0]['rlevel']); ?>
                </div>
                <h4>防控清单</h4>
                <div class="pl-20 controls">
                    <?php echo ($contents[3][0]['controls']); ?>
                </div>
            </div>
