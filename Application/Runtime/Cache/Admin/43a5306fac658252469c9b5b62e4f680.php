                ...
                <div class="uploader-list-container">
                    ...
                    <div class="statusBar" style="display:none;">
                        ...
                        <div class="btns">
                            ...
                            <input type="hidden" value="<?php echo U('Organize/updateInarchitecture','','');?>" id="uploadUrl"/>
                            <input type="hidden" value="<?php echo U('Organize/inarchitecture/','','');?>" id="viewUrl"/>
            ...
            function setState( val ) {
                ...
                switch ( state ) {
                    ...
                    case 'finish':
                        ...
                        if ( stats.successNum ) {
                            console.log($("#viewUrl").val());
                            var viewUrl = $("#viewUrl").val();
                            var viewUrl2 = $("#oid").val();

                            location.href=$("#viewUrl").val()+'/oid/'+$("#oid").val();
                        } else {
                            // 没有成功的图片，重设
                            state = 'done';
                            location.reload();
