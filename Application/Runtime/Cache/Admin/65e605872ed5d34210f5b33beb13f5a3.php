...
<div class="pd-20">
    <div class="cl pd-5 bg-1 bk-gray"><span class="l"><a href="javascript:;" onclick=user_add('添加用户','<?php echo U("add",array("oid"=>$oid));?>') class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span>
        <div class="text-r">
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <?php if(is_array($users)): $k = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($k % 2 );++$k;?><tr class="text-c">
                <td><?php echo ($k); ?></td>
                <td><input type="text" value="<?php echo ($user['id']); ?>" name="" class="sort input-text text-c"></td>
                ...
                <td><?php echo (date('Y-m-d',$user['updatetime'])); ?></td>
                <td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a title="编辑" href="javascript:;" onclick="user_add('管理员编辑','yhgl_yh_edit.html')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
