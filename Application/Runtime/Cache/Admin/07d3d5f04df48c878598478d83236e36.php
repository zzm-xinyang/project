...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            <label class="form-label col-1"><span class="c-red">*</span>运行流程：</label>
            <div class="formControls col-6">
                <input type="text" class="input-text"  name="power" id="power" value="">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-1"><span class="c-red">*</span>排序：</label>
            <div class="formControls col-6">
                <input type="text" class="input-text" value="<?php echo ($nextOrder); ?>" name="orders">
            </div>
        </div>
        <div class="row cl">
                ...
                <div class="uploader-list-container">
                    ...
                    <div class="statusBar" style="display:none;">
                        ...
                        <div class="btns">
                            ...
                            <input type="hidden" value="<?php echo U('save','','');?>" id="uploadUrl"/>
                            <input type="hidden" value="<?php echo U('index','','');?>" id="viewUrl"/>
                            <input type="hidden" value="<?php echo ($oid); ?>" id="oid" name="oid"/>
                            <input type="hidden" value="<?php echo ($mid); ?>" id="mid" name="mid"/>
                            <div class="uploadBtn">开始上传</div>
                            &nbsp;<button onClick="layer_close();" class="btn btn-default radius" type="button" style="height:43px;">&nbsp;&nbsp;取消&nbsp;&nbsp;</button>
                ...
                switch ( state ) {
                    ...
                    case 'finish':
                        ...
                        if ( stats.successNum ) {
                           ...
                           //var viewUrl2 = $("#oid").val();

                            location.href=$("#viewUrl").val()+'/oid/'+$("#oid").val()+'/mid/'+$("#mid").val();
                        } else {
                            // 没有成功的图片，重设
                            state = 'done';
                            location.reload();
