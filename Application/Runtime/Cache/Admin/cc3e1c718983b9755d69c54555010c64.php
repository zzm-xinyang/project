...
<table class="table table-border table-bordered table-hover table-bg table-sort">
    <thead>
        <tr class="text-c">
            ...
            <th colspan="2">警示谈话人</th>
            <th colspan="3">警示谈话对象</th>
            <th rowspan="2" width="80px">警示谈话时间</th>
            <th rowspan="2" width="80px">警示谈话地点</th>
    ...
    <tbody>
        <?php if(is_array($dataResult)): $i = 0; $__LIST__ = $dataResult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><a title="修改" class="ml-5" onclick="jtzr_edit('修改执纪问责','<?php echo U(zjwzxt1_edit_wz,array(rid=>$vo[id]));?>')" href="javascript:;"><i
                        class="Hui-iconfont">&#xe6df;</i></a></a> <a title="删除" href="javascript:;"
                                                                     onclick="wz_del(this,'<?php echo ($vo[id]); ?>')" class="ml-5"
